...
# import argparse
#
# from to_evaluate.process_sql import get_schema, Schema, get_sql
# from to_evaluate.exec_eval import eval_exec_match
#
...
#
#
# def evaluate_spiderology(gold, predict, db_dir, etype, kmaps, plug_value, keep_distinct, progress_bar_for_each_datapoint, output_path):
#     results_exec = []
#     results_match = []
#     results_partial = []
#     with open(gold) as f:
...
#                     results_exec.append(1)
#                 else:
#                     turn_scores['exec'].append(0)
#                     results_exec.append(0)
#             if etype in ["all", "match"]:
...
#                 results_partial.append(partial_scores)
#                 if exact_score == 0:
#                     results_match.append(0)
#                     turn_scores['exact'].append(0)
#                     print("{} pred: {}".format(hardness, p_str))
#                     print("{} gold: {}".format(hardness, g_str))
#                     print("")
#                 else:
#                     results_match.append(1)
...
#     results_dict = [{"exec": _e, "match": _m} for _e, _m in zip(results_exec, results_match)]
...
#
#     # gold = "spiderology/natural_sql_7b/gold.txt"
#     # prediction = "spiderology/natural_sql_7b/prediction.txt"
#     # db = "spiderology/databases"
#     # tables = "spiderology/tables.json"
#     # out = "spiderology/results_with_quotes.json"
#     # kmaps = build_foreign_key_map_from_json(tables)
#     # evaluate_spiderology(gold, prediction, db, "all", kmaps, False, False, False, out)
#
#     # gold = "dev/natural_sql_7b/gold.txt"
#     # prediction = "dev/natural_sql_7b/prediction_dequoted.txt"
#     # db = "dev/databases"
#     # tables = "dev/tables.json"
#     # out = "dev/results_dequoted.json"
#     # kmaps = build_foreign_key_map_from_json(tables)
#     # evaluate_spiderology(gold, prediction, db, "all", kmaps, False, False, False, out)
#
#     # gold = "spiderology/gold.txt"
#     # prediction = "spiderology/defog-sqlcoder_prediction.txt"
#     # db = "spiderology/databases"
#     # tables = "spiderology/tables.json"
#     # out = "spiderology/defog-sqlcoder_results.json"
#     # kmaps = build_foreign_key_map_from_json(tables)
#     # evaluate_spiderology(gold, prediction, db, "all", kmaps, False, False, False, out)
#
#     # gold = "spiderology/gold.txt"
#     # prediction = "spiderology/juierror_prediction.txt"
#     # db = "spiderology/databases"
#     # tables = "spiderology/tables.json"
#     # out = "spiderology/juierror_results.json"
#     # kmaps = build_foreign_key_map_from_json(tables)
#     # evaluate_spiderology(gold, prediction, db, "all", kmaps, False, False, False, out)
#
#     # gold = "dev/natural_sql_7b/gold.txt"
...
#
#     # gold = "lower/gold.txt"
#     # prediction = "lower/defog.txt"
#     # db = "spiderology/databases"
#     # tables = "spiderology/tables.json"
#     # out = "lower/defog.json"
#     # kmaps = build_foreign_key_map_from_json(tables)
#     # evaluate_spiderology(gold, prediction, db, "all", kmaps, False, False, False, out)
#
#
#     gold = "four/gold.txt"
#     # prediction = "four/defog-sqlcoder_prediction.txt"
#     # prediction = "four/natural-sql-7b_prediction.txt"
#     #  prediction = "four/natural-sql-7b_prediction_dequoted.txt"
#     prediction = "four/defog-sqlcoder_prediction_dequoted.txt"
#     db = "spiderology/databases"
#     tables = "spiderology/tables.json"
#     out = "four/defog-sqlcoder_exact_results.json"
#     # out = "four/natural-sql-7b_exact_results.json"
#     kmaps = build_foreign_key_map_from_json(tables)
#     evaluate_spiderology(gold, prediction, db, "all", kmaps, False, False, False, out)
...
if __name__ == "__main__":
    ...
    # prediction = "five/defog-sqlcoder_prediction_dequoted.txt"
    # out = "five/defog-sqlcoder_exact_results.json"

    # prediction = "five/defog-sqlcoder_prediction.txt"
    # out = "five/defog-sqlcoder_exec_results.json"

    prediction = "five/natural-sql-7b_prediction_dequoted.txt"
    out = "five/natural-sql-7b_exact_results.json"

    # prediction = "five/natural-sql-7b_prediction.txt"
    # out = "five/natural-sql-7b_exec_results.json"
